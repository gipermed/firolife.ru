                ...
                <div class="footer-col footer-col-contacts flex-row-item">
                    <div class="footer-contacts">
                        <div class="footer-social">
                            <div class="footer-title">Firolife в соцсетях:</div>
                            <ul class="social-list">
                                <li>
                                    <a href="https://vk.com/gipermed" aria-label="VK" target="_blank">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/social-vkontakte.svg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://ok.ru/medoborudo" aria-label="OK" target="_blank">
                                ...
                                <?/*li>
                                    <a href="https://twitter.com/gipermed_group" aria-label="Twitter" target="_blank">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/social-twitter.svg" alt="">
                                    </a>
                                </li*/?>
                                <li>
                                    <a href="https://www.youtube.com/channel/UCMb0--_oRvzGGYv-Bu_w8zQ" aria-label="Youtube" target="_blank">
                        ...
                        <ul class="footer-contacts-links footer-menu hidden-mobile">
                            ...
                            <li><a data-fancybox="" data-type="ajax" data-touch="false" data-src="/local/ajax/form/recall.php?ajax=y" href="javascript:void(0)">Заказать звонок</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="foot-row flex-row">
                <div class="foot-col flex-row-item">
                    <div class="copyright">© <?= date('Y') ?>. Firolife.ru. Все права защищены.</div>
                </div>
                <div class="foot-col flex-row-item">
