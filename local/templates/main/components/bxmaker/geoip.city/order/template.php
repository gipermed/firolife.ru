...
if ($arParams['CITY_SHOW'] == 'Y') {
    ?>
        <?php 
    $APPLICATION->IncludeComponent("bxmaker:geoip.city.line", "order", array("COMPONENT_TEMPLATE" => ".default", "CACHE_TYPE" => $arParams['CACHE_TYPE'], "CACHE_TIME" => $arParams['CACHE_TIME'], "COMPOSITE_FRAME_MODE" => $arParams['COMPOSITE_FRAME_MODE'], "COMPOSITE_FRAME_TYPE" => $arParams['COMPOSITE_FRAME_TYPE'], "CITY_LABEL" => $arParams['~CITY_LABEL'], "QUESTION_SHOW" => $arParams['QUESTION_SHOW'], "QUESTION_TEXT" => $arParams['~QUESTION_TEXT'], "INFO_SHOW" => $arParams['~INFO_SHOW'], "INFO_TEXT" => $arParams['~INFO_TEXT'], "BTN_EDIT" => $arParams['~BTN_EDIT']), $component, array('HIDE_ICON' => 'Y'));
    ?>
    <?php 
}
?>
