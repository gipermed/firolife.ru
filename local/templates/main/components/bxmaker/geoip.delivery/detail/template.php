...
if ($arParams['IS_AJAX'] == 'N') {
    ...
    ?>
        ...
        <div class="bxmaker__geoip__delivery-box js-bxmaker__geoip__delivery-box" data-city="<?php
    // =$arParams['CITY'];
    ?>" data-location="<?php 
    // =$arParams['LOCATION'];
    ...
    if (\count($arResult['ITEMS'])) {
        ...
        foreach ($arResult['ITEMS'] as $delivery) {
            ?>
                        ...
                        <p class="bxmaker__geoip__delivery-box-item  bxmaker__geoip__delivery-box-item--<?php
            echo $delivery['ID'];
            ?>">
    ...
    if (\count($arResult['ITEMS'])) {
        ...
        foreach ($arResult['ITEMS'] as $delivery) {
            ?>
                ...
                <p class="bxmaker__geoip__delivery-box-item  bxmaker__geoip__delivery-box-item--<?php echo $delivery['ID'];?>">
					<?php 
                    $img = \false;
