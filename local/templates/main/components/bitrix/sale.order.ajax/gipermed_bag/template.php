                ...
                <div class="cart-body cart__blocks order__blocks<?if($un_authorized):?> unauth<?endif;?>">
                    ...
                    <div class="order__section order__phone-block">
                        <div class="order__section-head">
                            <div class="order__section-title">Регистрация или вход в личном кабинете</div>
                        </div>
                        <div class="order__section-desc">
                            Введите ваш номер телефона, для регистрации или входа в личный кабинет, чтобы мы могли сообщить вам о статусе заказа
                        </div>
                            ...
                            <div class="order__delivery-block">
                                ...
                                <div class="order__delivery-body">
                                    ...
                                    <div class="order__delivery-info">
                                        <div class="order__delivery-item" data-val="15">
                                            <div class="row">
                                                <div class="order__delivery-select col-lg-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="order__delivery-select-content">
                                        ...
                                        <div class="order__delivery-item active" data-val="14" data-val2="18" data-val3="21">
                                        ...
                                        <div class="order__delivery-item active" data-val="19" data-val2="23">
                    ...
                    <div class="cart-sidebar">
                        ...
                        <div class="cart-sidebar-checkbox">
                            ...
                            <div class="cart-sidebar__email" style="display: none;">
                                <input type="text" value="" placehholder="" class="cart-sidebar__input">
...
if($USER->IsAuthorized()):
    ...
    <?else:?>
        <script>
            $('input[name=ORDER_PROP_2]').val("<?=$arUser['PERSONAL_MOBILE'];?>@mail_test.ru");
        </script>
    <?endif;?>
    <script>
        $('input[name=ORDER_PROP_2]').val("<?=$arUser['EMAIL'];?>");
...
<script>
    $(document).ready(function(){
        ...
        $('.jsOrder__address[data-city='+$('.js-prymery__geoip__city__line-city:first').text()+']').show();
        if($('.jsOrder__address[data-city='+$('.js-prymery__geoip__city__line-city:first').text()+']').length == 0){
            $('.jsPersonalAddress').html('Для данного города у вас нет сохраненных адресов');
        }

        $('.bx-ui-sls-fake').val($('.js-prymery__geoip__city__line-city:first').text());
    });


    if($('.js-prymery__geoip__city__line-city:first').text().length > 0){
        var defCity = $('.js-prymery__geoip__city__line-city:first').text();
    }else{
    ...
    var widjet = new ISDEKWidjet({
        ...
        defaultCity: "<?=$_COOKIE['prymery_geoip_2_8_1_city']?>",
        cityFrom: 'Москва',
        link: false,
        hidedress: true,
        hidecash: true,
