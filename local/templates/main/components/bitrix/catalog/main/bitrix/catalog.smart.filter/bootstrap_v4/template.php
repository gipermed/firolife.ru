						...
						<div class="smart-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								<div class="smart-filter-input-group-checkbox-list">
										<?$count = 1;$show_more=false;foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="form-group form-check mb-1"<?if($count > 10):$show_more=true;?> style="display: none;"<?endif;?>>
												<input
													type="checkbox"
										...
										<?$count++;endforeach;?>
                                    <?if($show_more):?>
                                        <div class="filter__showmore"><span>Показать все</span></div>
                                    <?endif;?>
								</div>
							<?
								//endregion
