...
if($GLOBALS["PAGE"][1] == 'catalog'){
    LocalRedirect(str_replace('/catalog/','/product/',$APPLICATION->GetCurPage()));
}
/** @var array $arParams */
/** @var array $arResult */
...
?>
<div class="row bx-<?=$arParams['TEMPLATE_THEME']?> catalog-element_detail">
...
if($GLOBALS['PAGE'][1] == 'product'){
    $APPLICATION->AddChainItem("Каталог", "/product/");
