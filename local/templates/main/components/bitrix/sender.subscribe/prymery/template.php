...
<div class="bx-subscribe"  id="sender-subscribe">
    ...
    <form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" class="subscription-section-form form" action="<?=$arResult["FORM_ACTION"]?>">
        <?=bitrix_sessid_post()?>
        <input type="hidden" name="sender_subscription" value="add">
        <label class="form-block" aria-label="Электронная почта">
            <input class="input subscription-input" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
        </label>
        ...
        <?endif;?>
        <button class="subscription-submit btn" id="bx_subscribe_btn_<?=$buttonId?>">
            Подписаться
        </button>
    </form>
    <?
